...
@section('content')
    ...
    {!! Form::open(['method' => 'PATCH', 'route' => ["advertisement.update", $advertisement->id], 'class' => 'form claim-form', 'files' => true]) !!}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">Advertisement <small class="text-muted">Edit</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            <hr>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <div class="row form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('title', $advertisement->advertise_title, ['class' => 'form-control', 'placeholder' => 'Enter Title', 'required'=>'required']) !!}
                                </div><!--col-->
                            </div>
                            <div class="row form-group">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    {!! Form::select('size', $sizeList, $advertisement->advertise_size, ['class' => 'form-control', 'placeholder' => 'Select a size', 'required'=>'required']) !!}
                                </div><!--col-->
                            </div>
                        </div><!--form-group-->
                    </div><!--col-->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::text('link', $advertisement->advertise_link, ['class' => 'form-control', 'placeholder' => 'Enter Advertisement Link']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::textarea('advertisement_code', $advertisement->advertise_code, ['class' => 'form-control', 'rows' => 2, 'cols' => 40, 'placeholder' => 'Enter Advertisement Code']) !!}
