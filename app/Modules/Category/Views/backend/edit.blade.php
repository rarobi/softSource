...
@section('content')
    ...
    {!! Form::open(['method' => 'PATCH', 'route' => ["category.update", $category->id], 'class' => 'form claim-form', 'files' => true]) !!}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('name', $category->name, ['class' => 'form-control', 'placeholder' => 'Category Name', 'required'=>'required','data-error' => 'Please Enter Category Name']) !!}
                        </div><!--col-->
                    </div>
                    <div class="row form-group">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('position', $category->position, ['class' => 'form-control', 'placeholder' => 'Position', 'required'=>'required','data-error' => 'Please Enter Position']) !!}
