...
@section('content')
    <div class="card">
        <div class="card-header">
            <span class="card-title"><i class="fa fa-user ml-3"></i> User Create</span>
        </div>
        <!-- /.card-header -->
        {!! Form::open(['route'=>'users.store', 'method'=>'post','enctype'=>'multipart/form-data','id'=>'dataForm']) !!}
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('company_name','',['class'=>$errors->has('company_name')?'form-control is-invalid':'form-control','placeholder'=>'Company name']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('permanent_address','',['class'=>$errors->has('permanent_address')?'form-control is-invalid':'form-control required','placeholder'=>'Permanent address','rows'=>'5']) !!}
                    </div>
                </div>
                <div class="col-md-1">
                    <div class="form-group">
