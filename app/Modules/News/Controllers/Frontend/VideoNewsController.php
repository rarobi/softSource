...
class VideoNewsController extends Controller
{
    ...
    {
        $data['video_list'] = Videos::orderBy('id','desc')->get();
        return view("News::frontend.news.video", $data);
    }
    ...
    public function show($lang = 'en', $id)
    {
        ...
        $data['video_list'] = Videos::where('id', '!=', $id)->limit(4)->get();
        return view("News::frontend.news.video-details", $data);
    }
