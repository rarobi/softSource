                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 single-item">
                            <div class="cart-body">
                                <div class="col-md-4">
                                    <div class="thumb">
                                        <a href="{!! url('{lang}/bangladesh/1') !!}"><img src="{!! asset('assets/frontend/img/blog/1.jpg') !!}" alt="Thumb"></a>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="info">
                                        <h4>
                                            <a href="{!! url('{lang}/bangladesh/1') !!}">Friendly bachelor entrance</a>
                                        </h4>
                                        <p>
                                        <span>{{ \Carbon\Carbon::now()->format('M d, Y') }}</span><br>
                                            Minuter highest his arrived for put and. Hopes lived by rooms oh in no death house.
                                            Contented direction september but end led excellent ourselves may. Ferrars few arrival<br>
                                            <a class="text-bold" href="{!! url('{lang}/bangladesh/1') !!}">Read More</a>
                                        </p>
{{--                                        <div class="meta">--}}
{{--                                            <a href="{!! url('{lang}/bangladesh/1') !!}">Read More</a>--}}
{{--                                        </div>--}}
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 single-item">
                            <div class="item">
                                <div class="info">
                                    <h4>
                                        <a href="{!! url('{lang}/bangladesh/1') !!}">Advertise Section</a>
                                    </h4>
                                    <p>
                                        Minuter highest his arrived for put and. Hopes lived by rooms oh in no death house.
                ...
                <div class="col-md-4">
                    <h3><strong>Popular News</strong></h3>
                    <hr class="separator">
                    <div class="row">
                        <!-- Single Item -->
                        <div class="col-md-12 single-item">
                            <ul>
                                <li>
                                    <div class="col-md-4">
                                        <div class="thumb">
                                            <a href="blog-single-left-sidebar.html"><img src="{!! asset('assets/frontend/img/blog/1.jpg') !!}" alt="Thumb"></a>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <p>The story not being talked about in Myanmar<br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 single-item">
                            <div class="item">
                                <div class="info">
                                    <h4>
                                        <a href="{!! url('{lang}/bangladesh/1') !!}">Get Updates</a>
                                    </h4>
                                    <p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 single-item">
                            <div class="item">
                                <div class="info">
                                    <li class="follow-icon"><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Item -->
                        ...
                        <div class="col-md-3 single-item">
                            <div class="item">
                                <div class="info">
                                    <li class="follow-icon"><a href="#"><i class="fab fa-twitter"></i></a></li>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Item -->
                        ...
                        <div class="col-md-3 single-item">
                            <div class="item">
                                <div class="info">
                                    <li class="follow-icon"><a href="#"><i class="fab fa-pinterest"></i></a></li>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Item -->
                        ...
                        <div class="col-md-3 single-item">
                            <div class="item">
                                <div class="info">
                                    <li class="follow-icon"><a href="#"><i class="fab fa-skype"></i></a></li>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Item -->
