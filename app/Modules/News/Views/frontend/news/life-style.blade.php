...
@section('content')
    ...
    <div class="blog-area default-padding bottom-less">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h3><strong>Life Style</strong></h3>
                    <hr class="separator">
                    <div class="row">
                        <!-- Single Item -->
                        <div class="col-md-12 single-item">
                            <div class="cart-body">
                                ...
                                <div class="col-md-8">
                                    <div class="info">
                                        <h4>
                                            <a href="blog-single-left-sidebar.html">Friendly bachelor entrance</a>
                                        </h4>
                                        <p>
                                            ...
                                            <a class="text-bold" href="blog-single-left-sidebar.html">Read More</a>
                                        </p>
                                        {{--                                        <div class="meta">--}}
                                        {{--                                            <a href="blog-single-left-sidebar.html">Read More</a>--}}
                                        {{--                                        </div>--}}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 single-item">
                            <ul>
                                <li>
                                    ...
                                    <div class="col-md-8">
                                        <p>The story not being talked about in Myanmar</p>
