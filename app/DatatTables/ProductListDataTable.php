    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                ...
                $actionBtn = '<a href="/products/'.Encryption::encodeId($data->id).'/edit/" class="btn btn-xs btn-info action-edit" title="Edit Product"><i class="fa fa-edit"></i> Edit</a> ';
...
//            ->minifiedAjax('', null, request()->only(['from', 'to', 'team', 'user', 'category', 'status']))
    ...
    protected function getColumns()
    {
        return [
            ...
            'category'              => ['data' => 'product_category', 'name' => 'product_category_id', 'orderable' => true, 'searchable' => true],
            'type'                  => ['data' => 'product_type', 'name' => 'product_type_id', 'orderable' => true, 'searchable' => true],
