    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                ...
                $actionBtn = '<a href="/product-categories/'.Encryption::encodeId($data->id).'/edit/" class="btn btn-xs btn-info action-edit" title="Edit Product Category"><i class="fa fa-edit"></i> Edit</a> ';
