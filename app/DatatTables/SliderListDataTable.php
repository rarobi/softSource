    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                ...
                $actionBtn = '<a href="/settings/sliders/'.Encryption::encodeId($data->id).'/edit/" class="btn btn-xs btn-info action-edit" title="Edit Slider"><i class="fa fa-edit"></i> Edit</a> ';
                $actionBtn .= ' <a href="/settings/sliders/'.Encryption::encodeId($data->id).'/delete/" class="btn btn-xs btn-danger action-delete" title="Delete Slider"><i class="fa fa-trash"></i> Delete</a>';
