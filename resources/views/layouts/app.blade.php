...
<head>
    ...
    <title>{{ config('app.name', 'SoftSourceBD') }}</title>

    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="keywords" content="SoftSourceBD Template" />
    <meta name="description" content="SoftSourceBD - Responsive Template">
